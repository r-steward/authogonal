...
const performManualLogin = (credentials) => ({
    type: exports.PERFORM_MANUAL_LOGIN,
    credentials,
});
exports.performManualLogin = performManualLogin;
const requestedManualLogin = (credentials) => ({
    type: exports.REQUESTED_MANUAL_LOGIN,
    credentials,
});
exports.requestedManualLogin = requestedManualLogin;
const manualLoginSuccess = (authenticatedUser) => ({
    type: exports.MANUAL_LOGIN_SUCCESS,
    authenticatedUser,
});
exports.manualLoginSuccess = manualLoginSuccess;
const manualLoginFailure = (failureReason) => ({
    type: exports.MANUAL_LOGIN_FAILURE,
    failureReason,
});
...
const requestedSilentLogin = (credentials) => ({
    type: exports.REQUESTED_SILENT_LOGIN,
    credentials,
});
exports.requestedSilentLogin = requestedSilentLogin;
const silentLoginSuccess = (authenticatedUser) => ({
    type: exports.SILENT_LOGIN_SUCCESS,
    authenticatedUser,
});
exports.silentLoginSuccess = silentLoginSuccess;
const silentLoginFailure = (failureReason) => ({
    type: exports.SILENT_LOGIN_FAILURE,
    failureReason,
});
